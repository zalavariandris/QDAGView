...
class AbstractWidgetFactory(ABC):
    @abstractmethod
    def createNodeWidget(self, parent_widget, index):
        pass
    ...
    @abstractmethod
    def createInletWidget(self, parent_widget, index):
        pass
    ...
    @abstractmethod
    def createOutletWidget(self, parent_widget, index):
        pass
    ...
    @abstractmethod
    def createLinkWidget(self, parent_widget, index):
        pass
    ...
    @abstractmethod
    def createCellWidget(self, parent_widget, index):
        pass
